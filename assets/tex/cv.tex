...
\href{https://github.com/isaacgsmith}{\raisebox{-0.05\height}\faGithub\ username} \ $|$ \ 
% \href{https://linkedin.com/in/username}{\raisebox{-0.05\height}\faLinkedin\ username} \ $|$ \ 
\href{https://isaacgsmith.github.io}{\raisebox{-0.05\height}\faGlobe \ mysite.com} \ $|$ \ 
\href{mailto:isaacsmith0427@gmail.com}{\raisebox{-0.05\height}\faEnvelope \ email@mysite.com} \ $|$ \ 
\href{tel:+1 (248) 508-9387}{\raisebox{-0.05\height}\faMobile \ +00.00.000.000} \\
\end{tabularx}
...
%	PROJECTS
%----------------------------------------------------------------------------------------
\section{Projects and Unpublished Work}
\begin{tabularx}{\linewidth}{ @{}l r@{} }
